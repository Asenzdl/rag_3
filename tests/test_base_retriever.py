...
metadata={
    'has_code': True, 
    'chunk_index': 1, 
    'h1': 'Use the graph API', 
    'h2': 'Setup', 
    'description': '', 
    'doc_category': 'oss/python', 
    'file_path': 'data\\langchain_docs_separated\\oss\\python\\langgraph\\use-graph-api.md', 
    'title': 'Use the graph API - Docs by LangChain', 
    'doc_id': '5268d48ca5c2adc8', 
    'language': 'en', 
    'code_language': 'shellscript', 
    'lastmod': '2026-04-02 18:28:12.007000+00:00', 
...
def test_scheme():
    print("=" * 60)
    print("测试基础向量检索器 create_vector_retriever()")
    print("=" * 60)
    
    # 创建检索器
    retriever = create_vector_retriever(
        persist_directory="db/langchain_docs_db1",
        collection_name="langchain_docs1",
