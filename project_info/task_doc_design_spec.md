...
- [xxx.md](../.project/docs/task_x.x/xxx.md) - 技术主题说明
- [yyy.md](../.project/docs/task_x.x/yyy.md) - 技术主题说明
- ...
...
- [ ] 所有 docstring 中包含"设计意图"
- [ ] "为什么"在四类触发条件出现时已写清楚
- [ ] 步骤注释的组织方式为步骤编号 + 必要时用字母子步骤（如 2a, 2b, 2c）
- [ ] 质量标注已按触发条件补充注释
- [ ] 步骤涉及异常处理时已内联描述异常处理逻辑
- [ ] 步骤需要日志时已标注日志记录点
- [ ] 条件分支（>2 条路径）已使用条件分支树格式
- [ ] 注释中函数调用规则已遵守

### 核心章节自检

- [ ] 架构决策有覆盖度高的明确的方案对比和选择理由
- [ ] 错误处理策略（如补充）：异常已枚举且处理方式明确
- [ ] 测试策略（如补充）：Mock 边界、纯函数、关键场景已覆盖
- [ ] 代码蓝图已达到"施工图纸"级别的精度
- [ ] 常见坑点按 Task 实际情况列举（不设最低数量）
- [ ] **不含完整实现代码**
- [ ] **不含测试代码**
